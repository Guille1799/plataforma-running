...
class GarminHealthService:
    ...
    def fetch_stress_data(
        ...
        try:
            ...
            stress_values = [s.get("stressLevel", -1) for s in stress if isinstance(s, dict)]
    ...
    def fetch_body_battery(
        ...
        try:
            ...
            bb_values = [entry.get("charged") for entry in bb_data if isinstance(entry, dict) and entry.get("charged")]
