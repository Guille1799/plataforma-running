...
/**
 * Dashboard Page - Uses adaptive layout based on device preference
 * This file exists for backwards compatibility but uses the same adaptive system
 */
...
export default function DashboardPage() {
  ...
  return (
    <>
      <div className="fixed top-4 right-4 px-3 py-1 bg-slate-800/50 rounded-lg text-xs text-slate-400 border border-slate-600 backdrop-blur z-50">
